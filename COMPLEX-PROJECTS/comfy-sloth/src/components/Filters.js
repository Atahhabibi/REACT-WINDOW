          ...
          <div>
            {
              categories.map((c,index)=>{
                return <button key={index} name='category' onClick={updateFilters}
          ...
          <div className='colors'>
            {
              colors.map((c,index)=>{
                ...
                if(c==='all'){
                  return <button key={index} data-color='all' onClick={updateFilters} className={`${color==='all'?' all-btn active':'all-btn'}`} name='color'>all</button>
                }
